...
namespace SolastaExtraContent
{
    public class Cantrips
    {
        ...
        static void createAcidClaws()
        {
            ...
            effect.Copy(DatabaseHelper.SpellDefinitions.VampiricTouch.EffectDescription);
            ...
            DatabaseHelper.SpellListDefinitions.SpellListDruid.spellsByLevel[0].spells.Add(acid_claws);
        }
        ...
        static void createThunderstrike()
        {
            ...
            DatabaseHelper.SpellListDefinitions.SpellListDruid.spellsByLevel[0].spells.Add(thunder_strike);
        }
        ...
        static void createAirBlast()
        {
            ...
            var sprite = SolastaModHelpers.CustomIcons.Tools.storeCustomIcon("AirBlastCantripImage",
                                                    $@"{UnityModManagerNet.UnityModManager.modsPath}/SolastaExtraContent/Sprites/AirBlast.png",
                                                    128, 128);
            ...
            DatabaseHelper.SpellListDefinitions.SpellListDruid.spellsByLevel[0].spells.Add(air_blast);
        }
        ...
        static void createFrostbite()
        {
            ...
            DatabaseHelper.SpellListDefinitions.SpellListDruid.spellsByLevel[0].spells.Add(frostbite);
        }
